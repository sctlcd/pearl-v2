...
ALLOWED_HOSTS = ['sctlcd-pearl-latest-version.herokuapp.com', "localhost", '127.0.0.1']
...
#
#     # Bucket Config
#     AWS_STORAGE_BUCKET_NAME = 'sctlcd-pearl-latest-version'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'pearl@example.com'
else:
